...
class Product extends Model
{
    ...
    {
        return $this->hasMany(ProductImage::class, 'product_id')->where('type', null)->orderBy('id', 'desc')->orderBy('main', 'asc');
    }

    public function imagesFB()
    {
         return $this->hasMany(ProductImage::class, 'product_id')->where('type', 'fb')->orderBy('id', 'desc');
    }
