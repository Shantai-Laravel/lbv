        ...
        <div class="row">
            <form class="form-reg" method="post" action="{{ route('blog-categories.update', $category->id) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12">
                                        @foreach($category->translations as $translation)
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="description_{{ $lang->lang }}" id="descr-{{ $lang->lang }}" class="form-control">{{ $translation->description }}</textarea>
                                            </div>
                                            @endif
                                        @endforeach
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        @foreach($category->translations as $translation)
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="info_{{ $lang->lang }}" id="info-{{ $lang->lang }}" class="form-control">{{ $translation->info }}</textarea>
                                            </div>
                                            @endif
                                        @endforeach
                                    </div>
                ...
                <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="gallery_id" id="gallery">
                                ...
                                @foreach ($galleries as $key => $gallery)
                                    <option value="{{ $gallery->id }}" {{ $gallery->id == $category->gallery_id ? 'selected' : '' }}>{{ $gallery->alias }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="img">select banner desktop</label>
                            <input type="file" name="banner_desktop" id="img"/><br>
                            @if ($category->banner_desktop)
                                <input type="hidden" name="old_banner_desktop" value="{{ $category->banner_desktop }}"/>
                                <img src="{{ asset('/images/blogCategories/og/'. $category->banner_desktop ) }}" style="height:70px;">
                            @else
                                <img src="{{ asset('admin/img/noimage.jpg') }}" style="height:70px;">
                            @endif
                        </div>
                        ...
                        <div class="form-group">
                            <label for="img">select banner mobile</label>
                            <input type="file" name="banner_mobile" id="img"/><br>
                            @if ($category->banner_mobile)
                                <input type="hidden" name="old_banner_mobile" value="{{ $category->banner_mobile }}"/>
                                <img src="{{ asset('/images/blogCategories/og/'. $category->banner_mobile ) }}" style="height:70px;">
                            @else
                                <img src="{{ asset('admin/img/noimage.jpg') }}" style="height:70px;">
                            @endif
                        </div>
                        ...
                        <div class="form-group">
                            <label for="img">select document file</label>
                            <input type="file" name="document" id="img"/><br>
                            @if ($category->doc)
                                <input type="hidden" name="old_document" value="{{ $category->document }}"/>
                                <a href="/images/blogCategories/docs/{{ $category->document }}" download>download doc</a>
                            @endif
                        </div>
                    </div>
                </div>
