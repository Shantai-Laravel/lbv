    ...
    <tr class="row100">
        ...
        <td class="column-number">
            <div class="form-check">
                <input type="checkbox" class="form-check-input" :id="'.com' + product.id"  v-model="product.homewear" @click="changeProductLocationLoungewear">
                <label class="form-check-label" :for="'.com' + product.id">Homewear</label>
            </div>
            <div class="form-check">
                <input type="checkbox" class="form-check-input" :id="'.md' + product.id" v-model="product.bijoux" @click="changeProductLocationJewelry">
                <label class="form-check-label" :for="'.md' + product.id">Bijoux</label>
            </div>
        </td>
        ...
        <td class="column-button">
            <span><i>{{ strCut(product.translations[0].name) }}</i></span>
            <button type="button" class="btn btn-default btn-sm" data-toggle="modal" :data-target="'#' + product.id"><i class="fa fa-image"></i> Images FB<span class="badge">{{ imagesFB.length }}</span> </button>
        </td>
        <td class="column-button">
            <span><i>{{ strCut(product.translations[0].name) }}</i></span>
